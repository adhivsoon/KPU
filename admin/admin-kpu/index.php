...
if (isset($_POST['simpan'])) {
  ...
  $login  = mysql_query("SELECT * FROM admin1 WHERE user='$user' AND pass='$pass'");
                    ...
                    <p class="center-align">
                      <div class="row">
                          <div class="input-field col s12">
                              <input type="text" name="username" placeholder="Username" user="username" required>
                              <label for="user"></label>
                          </div>
                      </div>
                      <div class="row">
                          <div class="input-field col s12">
                              <input type="Password" name="password" placeholder="Password" user="password" required>
                     ...
                     <div class="row">
                          <div class="col m12">
                              <p class="right-align">
                                <input type="submit" name="simpan" class="btn waves-effect waves-light" value="Masuk" />
                              </p>
                          </div>
                     </div>
                  </form>
