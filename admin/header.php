<div class="card-panel teal lighten-2">
  ...
  <div class="center" style="color:#FFFFFF">
    <h2 class="medium"><b class="z-depth-2">PEMILIHAN UMUM</b></h2>
    <!-- <hr width="400px"> -->
    <h3 class="light">Calon Presiden dan Calon Wakil Presiden Mahasiswa
    </br>Universitas Budi Luhur</br>Periode 2016 - 2017</h3>
  </div>
</div>
