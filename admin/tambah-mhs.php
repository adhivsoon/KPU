              ...
              <form class="col s12" action="tambah-mhs.php" method="POST" enctype="multipart/form-data" name="tbl_mhs">
                ...
                <div class="row">
                  <div class="input-field col s8 m4">
                      ...
                      <input id="status" type="text" name="status" value="0" class="validate" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" autocomplete=off required readonly>
